...
//  e.g. 23415 is a 5 digit long number containing all digits from 1 to 5 without 
// missing and repeating any digit from 1 to 5.
...
//  the face value and index of digits of number.e.g.
//  for 426135 (reading from right to left, 5 is in place 1, 3 is in place 2, 1 is in place 3, 6 is in place 4, 2 is in place 5 and 4 is in place 6),
...
public class InverseOfNum {
    public static void main(String[] args) {
        ...
        while (num != 0) {
            ...
            int nd = op;    //new digit would be original place
            int np = od;    //new place would be original digit
